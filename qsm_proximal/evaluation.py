...
test_path = '/home/kuowei/Desktop/MICCAI_result/lpcnn_all/'
...
for i in range(len(subject_list)):
	...
	for j in range(j_len):
		...
		test_img = nib.load(test_path + subject_list[i] + '_ori' + str(j+1) + '_LBVSMV_pred1_qsm.nii.gz')
