...
dataset_path = global_path + 'qsm_dataset/qsm_B_r/mix5_data/partition/partition_data_list4'
#dataset_path = global_path + 'qsm_dataset/qsm_B_r/mix5_data/whole/data_list'
...
for batch_count, (input_data, gt_data, mask_data, _, ang_data, _, input_name) in tqdm(enumerate(train_loader)):
